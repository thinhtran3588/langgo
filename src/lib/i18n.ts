...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'level.loading': 'Loading lessons...',
    'level.selectLessons': 'Select lessons for games',
    'learn.backToLesson': 'Back to lesson',
    'learn.newWord': 'New word',
    'learn.showAnswer': 'Show answer',
    'learn.next': 'Next',
    'learn.dialog': 'Dialog',
    'learn.nextDialog': 'Next dialog',
    ...
    'games.readDialog': 'Read dialog',
    'games.readDialogDesc': 'Read a random dialog from this level.',
    'games.playNow': 'Play now',
    'readDialog.title': 'Read dialog',
    'readDialog.next': 'Next dialog',
    'readDialog.empty': 'No dialogs available for this level yet.',
  ...
  vi: {
    ...
    'level.loading': 'Đang tải bài học...',
    'level.selectLessons': 'Chọn bài học cho trò chơi',
    'learn.backToLesson': 'Quay lại bài học',
    'learn.newWord': 'Từ mới',
    'learn.showAnswer': 'Hiện đáp án',
    'learn.next': 'Tiếp',
    'learn.dialog': 'Hội thoại',
    'learn.nextDialog': 'Hội thoại tiếp theo',
    'learn.prevLesson': 'Bài trước',
    'learn.nextLesson': 'Bài tiếp theo',
    ...
    'games.readDialog': 'Đọc hội thoại',
    'games.readDialogDesc': 'Đọc một hội thoại ngẫu nhiên trong cấp độ này.',
    'games.playNow': 'Chơi ngay',
    'readDialog.title': 'Đọc hội thoại',
    'readDialog.next': 'Hội thoại tiếp theo',
    'readDialog.empty': 'Chưa có hội thoại cho cấp độ này.',
