      ...
      {phase === 'words' && currentWord ? (
        <div className="space-y-6 rounded-3xl border border-zinc-200 bg-white p-6 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900/40">
          ...
          <div className="mt-6 space-y-3 text-left text-sm text-zinc-600 dark:text-zinc-300">
            ...
            currentWord?.radicals?.length ? (
              <div className="mt-4 flex flex-col gap-3 rounded-xl border border-zinc-100 bg-zinc-50/50 p-4 dark:border-zinc-800/60 dark:bg-zinc-900/50">
                {currentWord?.sinoVietnamese && (
                  <div className="flex flex-wrap items-center gap-2">
                ...
                {currentWord?.radicals && currentWord.radicals.length > 0 && (
                  <div className="space-y-2 pt-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {currentWord.radicals.map((radical, index) => (
                        <div
                          key={index}
